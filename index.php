...
<div class="card-body text-center d-flex flex-column ">
  <h5 class="card-title">Numéro: <?php   echo $value['numero'] ;?></h5>
  <p class="card-text">Nom: <?php   echo $value['first_name']; ?></p>
  <p class="card-text">Type: <?php   echo $value['type1'] . ' ' . $value['type2']  ;?></p>

  <a href="index.php?fichepokeid=<?php echo $value['id']?>"class="btn btn-outline-dark mt-auto" > Fiche pokémon</a>
</div>
</div>
</div>
<?php
...
<div class="card ">
  ...
  <div class="card-body text-center d-flex flex-column">
    ...
    <a href="index.php?fichechampion=<?php echo $value['id']?>" class="btn btn-outline-dark mt-auto">Champion</a>
  </div>
</div>
</div>
<?php
